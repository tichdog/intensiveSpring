...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // Get a reference to the textRecord object's textInfo
            ...
            // Draw Quad around the bounds of the textRecord
            #region Draw Bounds
            if (ShowMeshBounds)
                DrawBounds();
            #endregion

            // Draw Quad around the rendered region of the textRecord.
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // Draw textRecord labels for metrics
        ...
        /// <summary>
        /// Method to draw rectangles around each word of the textRecord.
        /// </summary>
        /// <param name="text"></param>
        void DrawWordBounds()
        {
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    // If Word is split on more than one lineOne.
        ...
        /// <summary>
        /// Draw rectangle around each of the links contained in the textRecord.
        /// </summary>
        /// <param name="text"></param>
        void DrawLinkBounds()
        {
            ...
            for (int i = 0; i < textInfo.linkCount; i++)
            {
                ...
                // Iterate through each character of the link textRecord
                for (int j = 0; j < linkInfo.linkTextLength; j++)
                {
                    ...
                    // If Link is split on more than one lineOne.
        ...
        /// <summary>
        /// Draw Rectangles around each lines of the textRecord.
        /// </summary>
        /// <param name="text"></param>
        void DrawLineBounds()
        {
        ...
        /// <summary>
        /// Draw Rectangle around the bounds of the textRecord object.
        /// </summary>
        void DrawBounds()
        {
