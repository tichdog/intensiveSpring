...
namespace TMPro.Examples
{
    ...
    public class VertexShakeB : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            // Subscribe to event fired when textRecord object has been regenerated.
        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            // We force an update of the textRecord object since it would only be updated at the end of the frame. Ie. before this code is executed on the first frame.
            // Alternatively, we could yield and wait until the end of the frame when the textRecord object will be generated.
            ...
            while (true)
            {
                ...
                // If No Characters then just yield and wait for some textRecord to be added
                if (characterCount == 0)
                {
                ...
                // Iterate through each lineOne of the textRecord.
                for (int i = 0; i < lineCount; i++)
                {
                    ...
                    for (int j = first; j <= last; j++)
                    {
                        ...
                        // Get the index of the first vertex used by this textRecord element.
                        int vertexIndex = textInfo.characterInfo[j].vertexIndex;

                        // Get the vertices of the mesh used by this textRecord element (character or sprite).
                        ...
                        // Need to translate all 4 vertices of each quad to aligned with the center of the lineOne.
                        // This is needed so the matrix TRS is applied from the center of the lineOne.
                        ...
                        // Apply the matrix TRS to the individual characters relative to the center of the current lineOne.
                        copyOfVertices[materialIndex][vertexIndex + 0] = matrix.MultiplyPoint3x4(copyOfVertices[materialIndex][vertexIndex + 0]);
                        copyOfVertices[materialIndex][vertexIndex + 1] = matrix.MultiplyPoint3x4(copyOfVertices[materialIndex][vertexIndex + 1]);
                        copyOfVertices[materialIndex][vertexIndex + 2] = matrix.MultiplyPoint3x4(copyOfVertices[materialIndex][vertexIndex + 2]);
                        copyOfVertices[materialIndex][vertexIndex + 3] = matrix.MultiplyPoint3x4(copyOfVertices[materialIndex][vertexIndex + 3]);
